...
# new files 10/18/2025
filenames <- list.files('../data/VOC sampling window data 20251018/')
filenames <- filenames[grep('.csv', filenames)]

for (i in 1:length(filenames)) {
  col_names <- read_csv(paste0('../data/VOC sampling window data 20251018/', filenames[i]), n_max = 0) %>% names()
  units <- read_csv(paste0('../data/VOC sampling window data 20251018/', filenames[i]), skip = 1, n_max = 0) %>% names()
  data <- read_csv(paste0('../data/VOC sampling window data 20251018/', filenames[i]), skip = 1)
