...
# Regress concentration of Benzene against wind and flare
benzene_count_20km <- lm(benzene.night ~ wdr_deg.night + wsp_ms.night + flare_wd_night_20 + flare_count_20, data = vnf_trailer_full)
summary(benzene_count_20km)
```
