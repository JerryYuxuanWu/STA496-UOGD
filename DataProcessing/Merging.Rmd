...
flaring <- readRDS('FlaringProcessed20250909.rds')
Trailer <- readRDS('TrailerProcessed20250909.rds')
# Weather <- readRDS('WeatherProcessed.rds')
Wells <- readRDS('WellsProcessed20250909.rds')
```
...
## Saving
```{r}
saveRDS(Trailer_hourly_merge, "Trailer_hourly_merge_20250909.rds")
saveRDS(Trailer_daily_merge, "Trailer_daily_merge_20250909.rds")
```
