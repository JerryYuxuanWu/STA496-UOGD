...
```{r}
wind_plot <- get_wind_plots(W, y_axis_upper = c(5, 1.5, 2, 3, 3.5))
...
```{r}
wind_plot <- get_wind_plots(W, y_axis_upper = c(3, 1.5, 1.3, 1.75, 3.75))
grid.arrange(grobs = wind_plot, ncol = 3)
```
...
```{r}
wind_plot <- get_wind_plots(W, y_axis_upper = c(0.5, 0.3, 0.225, 0.2, 0.25))
grid.arrange(grobs = wind_plot, ncol = 3)
```
