...
```{r}
# compute weight matrix (uncertainties or error)
# Based on the Guha paper

weight_matrix <- matrix(0, nrow = nrow(normalized_matrix_less_o3), 
...
for (i in 1:dim(weight_matrix)[1]) { 
  for (j in 1:dim(weight_matrix)[2]) {
