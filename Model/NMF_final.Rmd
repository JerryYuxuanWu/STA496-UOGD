...
```{r}
# normalize all
hourly_nona_bgrm_norm <- as_tibble(sapply(as.list(hourly_nona_bgrm), 
                                                   normalize_column)) 
...
#   .options = list('keep.all'=TRUE)
# )
# lsnmf_nndsvd_less_o3_test@.Data
# Each of the 5 models are obviously identical as we're using nndsvd without randomization.
```
...
lsnmf_nndsvd_less_o3_test2b <- nmf(
  normalized_matrix_less_o3,
  rank = 5,
  method = "ls-nmf",
...
lsnmf_nndsvd_less_o3_test2a
lsnmf_nndsvd_less_o3_test2b
```
