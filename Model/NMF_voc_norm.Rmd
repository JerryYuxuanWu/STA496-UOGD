...
hourly_non_vocs <- hourly_nona %>% select(all_of(non_vocs)) %>% rename('co2' = 'co2_ppm')
...
```{r, include = FALSE, eval=TRUE, echo = FALSE, fig.height=15, fig.width=16}
...
# ) %>%
#   pivot_longer(cols = c(1:5), names_to = 'component', values_to = 'component_wind')
# data_to_plot %>%
#   ggplot(aes(x = wd, y = component_wind, group = wd, fill = component)) +
#   geom_boxplot() +
