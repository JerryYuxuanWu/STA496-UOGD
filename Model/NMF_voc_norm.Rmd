...
# estimate_rank <- nmfEstimateRank(normalized_matrix, 4:10, method = "ls-nmf", weight = weight_matrix, 30)
...
NFM1 <- subset(H_long, Component == '1')
# Plot
nmfplt_1_svd <- ggplot(NFM1, aes(x = Chemical, y = Contribution)) +
  geom_bar(stat = "identity", position = "dodge", fill = "orange") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  geom_text(aes(label = sprintf("%.3f", Contribution)), color = "blue", size = 3, nudge_y = 0.1) +
  labs(x = "Chemical", y = "Contribution", title = "Component 1 KL nndsvd")+
  theme(
  text = element_text(size = 14), # Base text size for all text elements
  axis.title = element_text(size = 16), # Size of axis titles
  axis.text = element_text(size = 12), # Size of axis text (tick labels)
...
```{r, eval=TRUE, echo = T, include=FALSE}
NFM2 <- subset(H_long, Component == '2')
# Plot
nmfplt_2_svd <- ggplot(NFM2, aes(x = Chemical, y = Contribution)) +
  geom_bar(stat = "identity", position = "dodge", fill ="orange") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  geom_text(aes(label = sprintf("%.3f", Contribution)), color = "blue", size = 3, nudge_y = 0.1) +
  labs(x = "Chemical", y = "Contribution", title = "Component 2 KL nndsvd")+
  theme(
  text = element_text(size = 14), # Base text size for all text elements
  axis.title = element_text(size = 16), # Size of axis titles
  axis.text = element_text(size = 12), # Size of axis text (tick labels)
...
NFM3 <- subset(H_long, Component == '3')
# Plot
nmfplt_3_svd <- ggplot(NFM3, aes(x = Chemical, y = Contribution)) +
  geom_bar(stat = "identity", position = "dodge", fill = "orange") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  geom_text(aes(label = sprintf("%.3f", Contribution)), color = "blue", size = 3, nudge_y = 0.1) +
  labs(x = "Chemical", y = "Contribution", title = "Component 3 KL nndsvd")+
  theme(
  text = element_text(size = 14), # Base text size for all text elements
  axis.title = element_text(size = 16), # Size of axis titles
  axis.text = element_text(size = 12), # Size of axis text (tick labels)
...
NFM4 <- subset(H_long, Component == '4')
# Plot
nmfplt_4_svd <- ggplot(NFM4, aes(x = Chemical, y = Contribution)) +
  geom_bar(stat = "identity", position = "dodge", fill = "orange") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  geom_text(aes(label = sprintf("%.3f", Contribution)), color = "blue", size = 3, nudge_y = 0.1) +
  labs(x = "Chemical", y = "Contribution", title = "Component 4 KL nndsvd")+
  theme(
  text = element_text(size = 14), # Base text size for all text elements
  axis.title = element_text(size = 16), # Size of axis titles
  axis.text = element_text(size = 12), # Size of axis text (tick labels)
...
```{r, eval=TRUE, echo = FALSE, fig.height=15, fig.width=20, fig.cap='ls-nmf'}
grid.arrange(nmfplt_1_ls, nmfplt_2_ls, nmfplt_3_ls, nmfplt_4_ls, ncol=2)
```

```{r, fig.height=8, fig.width=20}
grid.arrange(nmfplt_2_ls, nmfplt_1_svd, ncol = 2)
```
```{r, fig.height=8, fig.width=20}
grid.arrange(nmfplt_1_ls, nmfplt_2_svd, ncol = 2)
```
```{r, fig.height=8, fig.width=20}
grid.arrange(nmfplt_3_ls, nmfplt_4_svd, ncol = 2)
```

```{r, fig.height=8, fig.width=20}
grid.arrange(nmfplt_4_ls, nmfplt_3_svd, ncol = 2)
```
