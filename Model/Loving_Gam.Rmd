...
daily_v2 <- mgcv::gam(radon_pCi_mean ~ temp_f_mean + pressure_altcorr_mean + wsp_mean + co2_ppm_mean + ch4_mean + h2o_sync_mean + ethene_mean + acetylene_mean + cyclopentane_mean + i.pentane_mean + n.pentane_mean, data = loving_daily_noflares)
